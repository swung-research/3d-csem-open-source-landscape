...
% % == Notes to implement from feedback of Wim ==
%
...
% % == Notes form Paulo ==
%
% Congratulations on the paper; it is well written and has relevant
% conclusions. Very good to know that the Ex responses are well represented.
% For most of the inversions done in the industry, we use these fields only.
%
