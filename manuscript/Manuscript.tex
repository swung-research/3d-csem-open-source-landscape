...
The finite-element kernel, including higher order basis functions and parallelisation, relies on the FEniCS project \citep{logg2012, langtangen2016}.
...
Primary field solutions are supplied by the COMET \citep{skibbe2020coupled} package.
...
The provided meshing tools based on TetGen \citep{si2015tetgen} and functionalities of pyGIMLi \citep{CAG.17.Rucker} facilitate the generation of tetrahedral meshes including layered-earth geometries with topography or bathymetry and anomalous bodies which are allowed to be connected or to reach the surface.
