...
\tabl[btp]{codecomparison}{All codes solve Maxwell's equations in its
  ...
  solvers such as \texttt{PETSc}, \texttt{MUMPS}, \texttt{FEniCS}
  \citep{CSE.15.Alnaes}, or \texttt{PARDISO} \citep{FGCS.04.Schenk}.
...
\begin{tabularx}{\linewidth}{lXXXX}
  ...
  BC & PEC & PEC & Neumann; Dirichlet & Dirichlet; Neumann \\
  Solver & \texttt{PETSc}; \texttt{MUMPS} & \emg3d & \texttt{FEniCS} &
