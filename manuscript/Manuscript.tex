...
\title[3D CSEM Open-Source Landscape]{\replaced{Towards an open-source landscape for 3D CSEM modelling}{Open-source landscape for 3D CSEM modelling}}
...
% TODO delete before re-submission
\begin{itemize}
