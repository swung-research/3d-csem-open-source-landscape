...
\itodo{Expand and adjust, wait for final result \simpeg (same mesh or different mesh?); some of this might be outdated.}
...
\ymark{We could remove Table 4, as \#procs and \#doc are equal, and runtime and memory are almost identical for all codes in these two examples. What do you think? I would then replace it in the following way:
«The corresponding required runtime and memory are \added{almost identical to the ones for the layered model} listed in Table~\replaced{\ref{tbl:comp-layered}}{\ref{tbl:comp-block}}.»}
%
\begin{table*}
\begin{minipage}{10cm}
  \centering
