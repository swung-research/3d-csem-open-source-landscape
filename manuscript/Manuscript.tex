...
\citep{CAG.15.Cockett}. All four codes have their user-facing routines written
...
(quasi-static approximation)} diffusive approximation, hence neglecting
displacement currents. The machines on which the different codes were run are
listed in Table~\ref{tbl:machines}, together with the responsible operator.
